...
Welcome To the MorenoNet For DirecTV Recievers Project!
This Will Lead You Through setting up A Free experience for yourself
Note: This a Windows OS Project, Linux Codes Are Being Found
1. Download morenoNet_ssdp.py
2. Download the python install Manager and install it
3. Open File Explorer
4. Click the Python File
5. it will  show:
